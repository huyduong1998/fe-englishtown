...
const ScheduleClassPassForm = (props) => {
          ...
          schedules.map((schedule, index) => {
            ...
            if (startDate.getDate() == date.getDate()) {
              ...
              if (time.getHours() == startTime.getHours()) {
                return (
                  <ScheduleOtherCard key={index} onClick={props.onClick} schedule={schedule} status={StudentScheduleStatus.past} />
                );
              }
              return null;
            } else {
...
export default ScheduleClassPassForm